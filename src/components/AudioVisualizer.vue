...
const audioElement = inject(audioElementInjectionKey) as HTMLMediaElement
...
const canvas: HTMLMediaElement = $ref()
let visualizer: AudioMotionAnalyzer = $ref()
let container: HTMLCanvasElement

/* setInterval(() => {
  console.log('VISUALIZER', visualizer?.energy, visualizer?.isOn)
}, 3e3)
 */
...
watch(
  (): HTMLMediaElement | undefined => audioElement,
  (n: HTMLMediaElement | undefined) => {
